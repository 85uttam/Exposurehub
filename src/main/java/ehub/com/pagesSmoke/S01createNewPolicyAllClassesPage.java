...
public class S01createNewPolicyAllClassesPage {
	...
	public String addOffshoreSchedule(String validationMessage) {
		String actual=common.addBulkScheduleGeneric(AppConstants.class_Offshore_Fraction_Value, AppConstants.country_Bangladesh, validationMessage);
		return actual;
	}
	
	public String addOffshoreRenewablesSchedule(String validationMessage) {
		String actual=common.addBulkScheduleGeneric(AppConstants.class_Offshore_Renewables_Fraction_Value, AppConstants.country_Brazil, validationMessage);
		return actual;
	}
