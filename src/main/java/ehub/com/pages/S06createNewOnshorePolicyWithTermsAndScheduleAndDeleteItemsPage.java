...
public class S06createNewOnshorePolicyWithTermsAndScheduleAndDeleteItemsPage {
	
	//private WebDriver driver;
	CommonLocatorsAndMethod common;

	public S06createNewOnshorePolicyWithTermsAndScheduleAndDeleteItemsPage(WebDriver driver) {
		//this.driver = driver;
	...
	public String createNewPolicy(String policyNumber) {
		 String createdPolicyVerify =common.createNewPolicyWithClassNameAndCoverageRule(policyNumber, AppConstants.policy_Assured + "06", 2, AppConstants.className_two_class_With_Same_Name);
