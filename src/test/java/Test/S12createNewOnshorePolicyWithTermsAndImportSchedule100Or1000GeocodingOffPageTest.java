...
public class S12createNewOnshorePolicyWithTermsAndImportSchedule100Or1000GeocodingOffPageTest extends BaseClass{
	...
	@Test(priority = 3, enabled = false, groups = { "Smoke", "Sanity", "Regression" })
	...
	@Test(priority = 4, enabled = false, groups = { "Smoke", "Sanity", "Regression" })
	...
	@Test(priority = 6, enabled = false, groups = { "Smoke", "Sanity", "Regression" })
